...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/elastic-vasp-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/elastic-vasp-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add elastic-vasp
# for installing globally
pixi global install elastic-vasp
```
...
It is possible to list all of the versions of `elastic-vasp` available on your platform:
...
```
pixi search elastic-vasp --channel conda-forge
```
